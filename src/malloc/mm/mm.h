...
static inline void
writemeta(block_t *blk, size_t sz, bool alloc, bool ismmap)
{
  blk->header.sz = sz;
...
static inline void
insertblk(free_block_t *blk, size_t buckidx)
{
...
removeblk(free_block_t *blk, size_t buckidx)
{
...
static inline void *
sliceblk(free_block_t *blk, size_t sz)
{
