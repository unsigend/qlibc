...
static inline long 
__syscall4(uint64_t __num, uint64_t __arg1, uint64_t __arg2, uint64_t __arg3, uint64_t __arg4){
    uint64_t ret;
...
static inline long 
__syscall5(uint64_t __num, uint64_t __arg1, uint64_t __arg2, uint64_t __arg3, uint64_t __arg4, uint64_t __arg5){
    uint64_t ret;
    register uint64_t r10 __asm__("r10") = __arg4;
    ...
    __asm__ volatile (
        "syscall"
        : "=a" (ret)
        : "a" (__num), "D" (__arg1), "S" (__arg2), "d" (__arg3), "r" (r10), "r" (r8)
        : "rcx", "r11", "memory"
    );
    return __syscall_ret(ret);
}
static inline long 
__syscall6(uint64_t __num, uint64_t __arg1, uint64_t __arg2, uint64_t __arg3, uint64_t __arg4, uint64_t __arg5, uint64_t __arg6){
    uint64_t ret;
    register uint64_t r10 __asm__("r10") = __arg4;
    register uint64_t r8 __asm__("r8") = __arg5;
    ...
    __asm__ volatile (
        "syscall"
        : "=a" (ret)
        : "a" (__num), "D" (__arg1), "S" (__arg2), "d" (__arg3), "r" (r10), "r" (r8), "r" (r9)
        : "rcx", "r11", "memory"
    );
    return __syscall_ret(ret);
}
