...
ERROR(0, "Undefined error: 0"), ERROR(EPERM, "Operation not permitted"),
    ...
    ERROR(EBUSY, "Resource busy"), ERROR(EEXIST, "File exists"),
    ...
    ERROR(ENAMETOOLONG, "File name too long"), ERROR(EHOSTDOWN, "Host is down"),
    ERROR(EHOSTUNREACH, "No route to host"),
    ERROR(ENOTEMPTY, "Directory not empty"),
    ERROR(EPROCLIM, "Too many processes"), ERROR(EUSERS, "Too many users"),
    ...
    ERROR(EPWROFF, "Device power is off"), ERROR(EDEVERR, "Device error"),
    ...
    ERROR(ECANCELED, "Operation canceled"), ERROR(EIDRM, "Identifier removed"),
    ERROR(ENOMSG, "No message of desired type"),
    ERROR(EILSEQ, "Illegal byte sequence"),
    ERROR(ENOATTR, "Attribute not found"), ERROR(EBADMSG, "Bad message"),
    ERROR(EMULTIHOP, "EMULTIHOP (Reserved)"),
    ERROR(ENODATA, "No message available on STREAM"),
    ERROR(ENOLINK, "ENOLINK (Reserved)"), ERROR(ENOSR, "No STREAM resources"),
    ERROR(EPROTO, "Protocol error"), ERROR(ETIME, "STREAM ioctl timeout")
