...
UTEST_TEST_CASE(integer_limits){
    ...
    EXPECT_EQUAL_UINT64(UINT_FAST8_MAX, UINT8_MAX);
    EXPECT_EQUAL_UINT64(UINT_FAST16_MAX, UINT64_MAX);
    EXPECT_EQUAL_UINT64(UINT_FAST32_MAX, UINT64_MAX);
    EXPECT_EQUAL_UINT64(UINT_FAST64_MAX, UINT64_MAX);
#elif defined(__aarch64__)
    EXPECT_EQUAL_INT64(INT_FAST8_MIN, INT8_MIN);
...
UTEST_TEST_CASE(integer_values){
    EXPECT_EQUAL_INT8(INT8_C(42), 42);
    EXPECT_EQUAL_INT16(INT16_C(42), 42);
    EXPECT_EQUAL_INT32(INT32_C(42), 42);
    EXPECT_EQUAL_INT64(INT64_C(42), 42);

    EXPECT_EQUAL_UINT8(UINT8_C(42), 42);
    EXPECT_EQUAL_UINT16(UINT16_C(42), 42);
    EXPECT_EQUAL_UINT32(UINT32_C(42), 42);
    EXPECT_EQUAL_UINT64(UINT64_C(42), 42);

    EXPECT_EQUAL_INT64(INTMAX_C(42), 42);
    EXPECT_EQUAL_INT64(INTMAX_C(-42), -42);
    EXPECT_EQUAL_UINT64(UINTMAX_C(42), 42);
}
UTEST_TEST_SUITE(stdint){
    ...
    UTEST_RUN_TEST_CASE(integer_values);
}