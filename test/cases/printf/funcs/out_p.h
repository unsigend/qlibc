...
UTEST_TEST_CASE(out_p)
{
  ...
  n = snprintf((char *)buf, BUFSZ, "%p", (void *)&var);
  ...
  n = snprintf((char *)buf, BUFSZ, "%p", (void *)&cvar);
  EXPECT_GREATER_INT(n, 2);
  EXPECT_EQUAL_INT(buf[0], '0');
  EXPECT_EQUAL_INT(buf[1], 'x');
  {
  ...
  n = snprintf((char *)buf, BUFSZ, "%p %p", (void *)&var, (void *)&cvar);
  ...
  n = snprintf((char *)buf, 5, "%p", (void *)&var);
  EXPECT_GREATER_INT(n, 2);
  EXPECT_EQUAL_INT(buf[0], '0');
  EXPECT_EQUAL_INT(buf[1], 'x');

  n = snprintf((char *)buf, 0, "%p", (void *)&var);
  EXPECT_GREATER_INT(n, 2);
  ...
  n = snprintf((char *)buf, BUFSZ, "addr=%p", (void *)&var);
  ...
  {
    long lvar;
    n = snprintf((char *)buf, BUFSZ, "%p", (void *)&lvar);
    EXPECT_GREATER_INT(n, 2);
    {
      unsigned long long parsed = strtoull((char *)buf, NULL, 0);
  ...
  {
    static int svar;
    n = snprintf((char *)buf, BUFSZ, "%p", (void *)&svar);
    EXPECT_GREATER_INT(n, 2);
    {
      unsigned long long parsed = strtoull((char *)buf, NULL, 0);
  ...
  n = snprintf((char *)buf, 3, "%p", (void *)&var);
  EXPECT_GREATER_INT(n, 2);
  EXPECT_EQUAL_INT(buf[0], '0');

  n = snprintf((char *)buf, 4, "%p", (void *)&var);
  EXPECT_GREATER_INT(n, 2);
  EXPECT_EQUAL_INT(buf[0], '0');
  EXPECT_EQUAL_INT(buf[1], 'x');
  ...
  {
    char *str = (char *)&var;
    n = snprintf((char *)buf, BUFSZ, "%p", (void *)str);
    EXPECT_GREATER_INT(n, 2);
    {
      unsigned long long parsed = strtoull((char *)buf, NULL, 0);
  ...
  n = snprintf((char *)buf, BUFSZ, "%20p", (void *)&var);
  ...
  n = snprintf((char *)buf, BUFSZ, "%*p", 0, (void *)&var);
  ...
  n = snprintf((char *)buf, BUFSZ, "%5p", (void *)&var);
